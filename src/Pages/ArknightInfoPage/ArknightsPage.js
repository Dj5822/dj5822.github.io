...
const ArknightsPage = () => {
    return (
        <div className={styles.arknightsPage}>
            ...
            <label for="email">Email: </label><input id="email" type="email" name="email" placeholder="Enter your email address"></input>
            <input id="submit" type="submit" value="Submit"></input>
            </form>
            <div id="rhodesIslandInfo" class="info">
            <img class="factionImage" src={logoRhodes} alt="Rhodes Island Logo"/>
            <p>
            ...
            <div id="penguinLogisticsInfo" class="info">
            <img class="factionImage" src={logoPenguin} alt="Penguin Logistics Logo"/>
            <p>
            ...
            <div id="rhineLabInfo" class="info">
            <img class="factionImage" src={logoRhine} alt="Rhine Lab Logo"/>
            <p>
            ...
            <div id="greatLungmenInfo" class="info">
            <img class="factionImage" src={logoLungmen} alt="Lungmen Logo"/>
            <p>
